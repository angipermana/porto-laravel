# Angi Permana - Portfolio Reference Profile
...
1. **Google Ads Manager**
   - Precise ad targeting, conversion-focused strategy, optimized ad spend.
2. **WordPress Developer**
   - Developing fast, mobile-friendly, secure, and SEO-optimized sites/landing pages.
   - Author of custom WordPress plugins (including WP Rotator, conversion-focused tools).
3. **Web Analytics & Tracking**
   - Expert integration of Google Analytics 4 (GA4), Google Tag Manager (GTM), and Facebook Pixel / Conversions API with high precision.

## Career Timeline / Milestones
- **2010 (Awal Perjalanan / Early Journey)**: Started from scratch by managing local businesses and joining blogger communities, eventually managing over 20+ websites.
